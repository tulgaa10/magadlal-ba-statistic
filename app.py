...
📋 ДАРААХ АЛХАМ:
   1. ✅ Энэ кодыг .py файл болгон хадгалах
   2. ⏳ PDF тайлан үүсгэх (доорх кодыг ашиглах)
   3. ⏳ PowerPoint үзүүлэн бэлтгэх
   4. ⏳ Багийн гишүүдийн үүрэг, оролцоог тодорхой бичих
   5. ⏳ Teams дээр хураалгах

💡 ЗӨВЛӨМЖ:
   • Бүх графикуудыг тайландаа оруулаарай
   • Үр дүнг тайлбарлахдаа хялбар ойлгомжтой болгож бичээрэй
   • Ашигласан эх сурвалжуудаа APA форматаар бичээрэй
   • Үзүүлэндээ хамгийн чухал мэдээллийг л оруулаарай (10-15 слайд)
""")
# ======================================================================
...
try:
    ...
    print(f"   Хуудасны тоо: 10")
    print(f"   Файлын хэмжээ: {os.path.getsize(pdf_file) / 1024 / 1024:.2f} MB")
except Exception as e:
    print(f"\n❌ АЛДАА: PDF үүсгэхэд алдаа гарлаа: {e}")

print("\n" + "=" * 80)
print("✅ БҮХИЙ Л АЖИЛ ДУУСЛАА!")
print("=" * 80)
